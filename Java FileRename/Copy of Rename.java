...
public class Rename extends JFrame implements ActionListener{	
    ...
    private void buildGUI(){
    	 ...
    	 *
    	 * dear dear, lan lan, says :
				actually sometimes i do un why you like programming
				coz after all the hardowrk,,,
				you can see the output
				and eventually
				you will feel satisifed and proud right>>
				these days..
				i keep on doing on java...
				but mine just very simple...
				completing all the practical questions will do
				and i do find the satisfaction
				after writing the code and sees it run...
				
				last time i dont un why you like programming so much
				but now i really und d...
				the satisafaction
				is there...
				especailly you can see the output
				am i right??
				 
				Alice Chua just sent you a nudge.
